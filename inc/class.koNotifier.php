			...
			if (($notLevel & $this->displayLevel) != 0) {
				foreach ($nots as $not) {
					if ($not['notText'] === null) {
						...
						print '<div class="alert alert-dismissable alert-'.strtolower($this->levelCodesToNames[$notLevel]).'"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>' . $LLLabel . '</div><br />';
					}
					else {
						print '<div class="alert alert-dismissable alert-'.strtolower($this->levelCodesToNames[$notLevel]).'"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'.$not['notText'].'</div><br />';
					}
				}
			}
		}
